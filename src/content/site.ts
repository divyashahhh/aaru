/*
  ...
  Anything wrapped in [square brackets] is a PLACEHOLDER pending a detail from
  the client (see Website Notes, Round 1 — Open items) rather than invented.
*/

export const site = {
  practice: "Aarushi Shah Therapy",
  name: "Aarushi Shah",
  practitioner: "Aarushi Shah",
  initials: "AS",
  discipline: "Psychotherapy",
  tagline: "A space to feel more alive.",
  location: "London",
  modality: "In person in London and online",
  email: "hello@aarushishahtherapy.com",
  phone: "+44 7837 210515",
  /* Booking link for the Contact page — pending from client. */
  calendlyUrl: "[Calendly link pending]",
};
...
/*
  Sitewide credentials box — appears on all four pages (currently rendered in
  the footer). Credentials list, then contact details underneath.
*/
export const credentials = [
  "BA Psychology (Hons) & MA Psychodynamic Counselling & Psychotherapy",
...
export const hero = {
  headline: "A space to feel more alive",
  subtext:
...
export const process = [
  {
    n: "01",
    title: "Reach out via email/call",
    body: "We can schedule a free consultation that best suits our schedules.",
  },
  {
    n: "02",
    title: "A first conversation",
    body: "A free 20-minute call to talk about what brings you here and whether we are a good fit.",
  },
  {
    n: "03",
    title: "Ongoing work",
    body: "Weekly sessions at a regular time, for as long as they remain useful to you.",
  },
];

export const closing =
  "Not sure if therapy with me is right for you? We can start with a free 15-minute conversation.";

/* ---------- About ---------- */

export const aboutOpening = {
  greeting: "Hello, I'm Aarushi.",
  body: "My path into psychotherapy grew from an interest in how people make sense of themselves, their relationships and the worlds they come from.",
};
...
export const sessionsFeel = [
  ...
  {
    title: "Relational",
    body: "I also work relationally, which means I see therapy as something we create together. I am not sitting back and analysing you from a distance. The relationship between us matters. How it feels to be understood, misunderstood, close, guarded, uncertain or comfortable can all become part of the work, if useful. I aim to offer a warm and honest space where you can speak freely and where we can think together about what is happening for you.",
  },
  {
    title: "What that can look like",
    body: "Sessions are a natural conversation, moving at your pace and shaped by what you want to explore. There is no right way to do therapy, and you do not need to arrive knowing what to say. If this is your first time in therapy, we can simply figure it out together as we go.",
  },
];
...
export const qualifications = [
  "BA Psychology (Hons), Yale-NUS College, National University of Singapore",
  "MA Psychodynamic Counselling and Psychotherapy",
  "BACP Registered Member (Membership No: [pending])",
];

/* ---------- Services ---------- */

export const forWhomIntro =
  "I offer therapy to adolescents (aged 12 and above) and adults, from any background and age.";
...
export const forWhom = [
  ...
  },
  {
    title: "For Adults",
    paragraphs: [
      "Who said you needed to have it all figured out as an adult? Adult life can bring its own periods of uncertainty, pressure and change. You may be dealing with anxiety, grief, difficult relationships, family expectations, loneliness, past experiences, burnout, identity questions or simply a sense that something in your life no longer feels right.",
      "You do not need to be in crisis to come to therapy. Sometimes it is enough to want a space to think, feel and understand yourself more clearly.",
      "Together, we can explore what you are carrying, the patterns that may be shaping your life, and what might help you feel more connected to yourself and the life you want to live.",
    ],
  },
];
...
export const areasOfInterest = [
  {
    ...
    paragraphs: [
      ...
      "Sessions are available in English, Hindi/Urdu and Gujarati, and you are welcome to move between languages naturally. The aim is for you to bring as much of yourself into the room as possible.",
    ],
  },
  {
    title: "Women's Reproductive & Hormonal Health",
    paragraphs: [
...
export const feesIntro =
  "Clear answers to the questions that most often sit in the way of getting started.";

export const fees = [
  { label: "Initial consultation (15 mins)", price: "Free" },
  { label: "Individual session, in person or online (50 mins)", price: "£80" },
  { label: "Low-cost counselling for students", price: "£40" },
];

export const feesNote =
  "If you are not a student, and would like to opt for low-cost counselling or any concessions, we can discuss this during the consultation.";
...
export const contactHeading = "Book a free 15-minute call to talk things through";
