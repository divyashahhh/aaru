      ...
      <div className="border-b border-antique/25 bg-salt/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-4 md:px-12 lg:px-20">
          ...
          <nav className="flex flex-wrap items-center gap-x-7 gap-y-2">
            ...
            <Link
              href="/contact"
              className="rounded-full bg-coffee px-6 py-2.5 text-[12px] font-medium uppercase tracking-[0.14em] text-salt shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-raisin hover:shadow-md active:translate-y-0"
            >
              Book a call
            </Link>
          </nav>
